            ...
            <section className="relative w-full h-[85vh] overflow-hidden">
                ...
                <div className="relative z-10 w-full h-full flex items-center container mx-auto px-6 md:px-12">
                    <div className="max-w-3xl space-y-8 pt-20">
                        ...
                        >
                            <button
                                onClick={() => setSelectedVideo(featuredVideo.src)}
            ...
            <section className="relative z-20 px-6 md:px-12 py-20 space-y-24">
                <div className="space-y-8">
                    <div className="flex items-end justify-between border-b border-white/10 pb-4">
                        <h3 className="text-3xl md:text-4xl font-serif text-white">Music <span className="italic text-gold">Videos</span> Collection</h3>
                        <span className="text-xs uppercase tracking-widest text-white/40 hidden md:block">Streaming Best Indian Music</span>
                    </div>
