...
const platforms = [
    {
        name: "Spotify",
        icon: (
            <svg viewBox="0 0 168 168" fill="currentColor" className="w-10 h-10 md:w-12 md:h-12 group-hover:text-[#1ED760] transition-colors duration-500">
    ...
    },
    {
        name: "Apple Music",
        icon: (
            <svg viewBox="0 0 361 361" fill="currentColor" className="w-10 h-10 md:w-12 md:h-12 group-hover:scale-110 transition-transform duration-500">
    ...
    },
    {
        name: "YouTube Music",
        icon: (
            <svg viewBox="0 0 408.8 139.8" fill="currentColor" className="h-10 md:h-12 w-auto group-hover:scale-110 transition-transform duration-500">
    ...
    },
    {
        name: "JioSaavn",
        icon: (
            <svg viewBox="0 0 32 32" fill="currentColor" className="w-10 h-10 md:w-12 md:h-12 group-hover:scale-110 transition-transform duration-500">
    ...
    },
    {
        name: "Amazon Music",
        icon: (
            <svg viewBox="0 0 89 52" fill="currentColor" className="h-10 md:h-12 w-auto group-hover:scale-110 transition-transform duration-500">
    ...
    },
    {
        name: "Wynk Music",
        icon: (
            <svg viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 md:w-12 md:h-12 group-hover:scale-110 transition-transform duration-500">
    ...
    },
    {
        name: "Gaana",
        icon: (
            <svg viewBox="0 0 74.9 25.1" fill="currentColor" className="h-10 md:h-12 w-auto group-hover:scale-110 transition-transform duration-500">
    ...
    },
    {
        name: "Tidal",
        icon: (
            <svg viewBox="0 0 12 12" fill="currentColor" className="w-10 h-10 md:w-12 md:h-12 group-hover:scale-110 transition-transform duration-500">
                ...
                <div className="hidden md:flex w-full overflow-hidden mask-linear-gradient">
                    ...
                    <TranslateWrapper>
                        {[...platforms, ...platforms, ...platforms].map((platform, index) => (
                            ...
                            >
                                <div className="w-16 h-16 md:w-20 md:h-20 flex items-center justify-center text-gold transition-all duration-500 transform group-hover:scale-110 group-hover:rotate-6 drop-shadow-[0_0_10px_rgba(212,175,55,0.3)] group-hover:drop-shadow-[0_0_15px_rgba(212,175,55,0.6)]">
                                    {platform.icon}
                                </div>
                ...
                <div className="grid grid-cols-2 gap-4 w-full px-6 md:hidden">
                    {platforms.map((platform, index) => (
                        <Link href="/music" key={index} className="flex flex-col items-center justify-center p-6 bg-zinc-900 rounded-xl border border-white/10 hover:border-gold/30 transition-all shadow-md">
                            <div className="w-12 h-12 flex items-center justify-center mb-3 text-gold drop-shadow-sm scale-110">
                                {platform.icon}
                            </div>
