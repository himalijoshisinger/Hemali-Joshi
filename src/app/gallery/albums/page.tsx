...
export const metadata: Metadata = {
    title: "Own Albums Gallery | Himali Joshi",
    description: "Explore the exclusive own album gallery of Himali Joshi, featuring original music and performances.",
};

const albumImages = [
    "/Own Album/DSC04529.jpg",
    "/Own Album/DSC04537.jpg",
    "/Own Album/DSC04563.jpg",
    "/Own Album/DSC04653.jpg",
    "/Own Album/DSC04684.jpg",
    "/Own Album/DSC04697.jpg",
    "/Own Album/DSC04859.jpg",
    "/Own Album/DSC05776.jpg",
    "/Own Album/DSC05804.jpg",
    "/Own Album/DSC05859.jpg",
    "/Own Album/DSC06003.jpg",
    "/Own Album/DSC06016.jpg",
    "/Own Album/DSC06530.jpg",
    "/Own Album/DSC06588.jpg",
    "/Own Album/DSC06658.jpg",
    "/Own Album/DSC06658 copy.jpg",
    "/Own Album/music1.jpg"
];
                ...
                <div className="columns-1 sm:columns-2 md:columns-3 gap-6 space-y-6 mb-32">
                    {albumImages.map((src, index) => (
                        <div key={index} className="break-inside-avoid relative group rounded-2xl overflow-hidden bg-white/5 border border-white/10 shadow-2xl cursor-pointer">
                            <Image
                                src={src}
                                alt={`Own Album by Himali Joshi - ${index + 1}`}
                                width={800}
                                height={1200}
