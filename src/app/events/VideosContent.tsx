...
export default function VideosContent() {
    ...
    const videos = [
        ...
        { id: 15, src: "/hitubhai.mp4", poster: "/assets/hituu.jpeg", title: "Hitu Kanodia (Gujarati Actor)", desc: "Appreciation and blessings from the famous superstar actor.", category: "celebrity" },
