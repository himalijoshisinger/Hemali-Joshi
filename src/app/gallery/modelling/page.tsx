...
export const metadata: Metadata = {
    title: "Modelling Gallery | Himali Joshi",
    description: "Explore the professional modelling portfolio of Himali Joshi.",
};

const modellingImages = [
    "/Modelling/DSC04529.jpg",
    "/Modelling/DSC04537.jpg",
    "/Modelling/DSC04563.jpg",
    "/Modelling/DSC04653.jpg",
    "/Modelling/DSC04684.jpg",
    "/Modelling/DSC04697.jpg",
    "/Modelling/DSC04859.jpg",
    "/Modelling/DSC05859.jpg",
    "/Modelling/DSC06658.jpg",
    "/Modelling/music1.jpg"
];

export default function ModellingGalleryPage() {
    return (
                ...
                <div className="columns-1 sm:columns-2 md:columns-3 gap-6 space-y-6 mb-32">
                    {modellingImages.map((src, index) => (
                        <div key={index} className="break-inside-avoid relative group rounded-2xl overflow-hidden bg-white/5 border border-white/10 shadow-2xl cursor-pointer">
                            <Image
                                src={src}
                                alt={`Modelling Portfolio by Himali Joshi - ${index + 1}`}
                                width={800}
                                height={1200}
