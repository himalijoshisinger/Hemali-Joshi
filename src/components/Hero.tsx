        ...
        <section className="relative h-screen w-full overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 bg-black flex items-center justify-center">
                <video
                    ...
                    style={{ filter: "contrast(1.1) saturate(1.1) blur(3px)" }} // Added blur(3px) for aesthetic premium feel
                >
            ...
            <div className="relative z-20 flex h-full flex-col items-center justify-center px-6 text-center">
                ...
                >
                    ...
                    <div className="font-serif italic text-[clamp(2.5rem,10vw,8rem)] leading-none drop-shadow-xl mb-4 md:mb-6">
                    ...
                    <h2 className="mb-8 font-serif text-[clamp(1.25rem,4vw,2rem)] italic leading-tight text-white/90 drop-shadow-lg">
